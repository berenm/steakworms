...
bool ISteamFriends::GetFriendGamePlayed(CSteamID steamIDFriend, struct FriendGameInfo_t *pFriendGameInfo) {
...
void ISteamFriends::GetFriendsGroupMembersList(FriendsGroupID_t friendsGroupID, CSteamID *pOutSteamIDMembers, int nMembersCount) {
...
bool ISteamFriends::GetClanActivityCounts(CSteamID steamIDClan, int *pnOnline, int *pnInGame, int *pnChatting) {
  debug("ISteamFriends::GetClanActivityCounts()");
  return true;
}
SteamAPICall_t ISteamFriends::DownloadClanActivityCounts(CSteamID *psteamIDClans, int cClansToRequest) {
...
CSteamID ISteamFriends::GetFriendFromSourceByIndex(CSteamID steamIDSource, int iFriend) {
  debug("ISteamFriends::GetFriendFromSourceByIndex()");
  return steam_id;
}
bool ISteamFriends::IsUserInSource(CSteamID steamIDUser, CSteamID steamIDSource) {
  debug("ISteamFriends::IsUserInSource()");
  return true;
}
void ISteamFriends::SetInGameVoiceSpeaking(CSteamID steamIDUser, bool bSpeaking) {
...
void ISteamFriends::ActivateGameOverlayToUser(const char *pchDialog, CSteamID steamID) {
...
bool ISteamFriends::RequestUserInformation(CSteamID steamIDUser, bool bRequireNameOnly) {
...
CSteamID ISteamFriends::GetClanOfficerByIndex(CSteamID steamIDClan, int iOfficer) {
...
const char *ISteamFriends::GetFriendRichPresence(CSteamID steamIDFriend, const char *pchKey) {
...
const char *ISteamFriends::GetFriendRichPresenceKeyByIndex(CSteamID steamIDFriend, int iKey) {
...
bool ISteamFriends::InviteUserToGame(CSteamID steamIDFriend, const char *pchConnectString) {
...
bool ISteamFriends::SendClanChatMessage(CSteamID steamIDClanChat, const char *pchText) {
  debug("ISteamFriends::SendClanChatMessage()");
  return true;
}
int ISteamFriends::GetClanChatMessage(CSteamID steamIDClanChat, int iMessage, void *prgchText, int cchTextMax, EChatEntryType *peChatEntryType, CSteamID *psteamidChatter) {
  debug("ISteamFriends::GetClanChatMessage()");
  return true;
}
bool ISteamFriends::IsClanChatAdmin(CSteamID steamIDClanChat, CSteamID steamIDUser) {
...
bool ISteamFriends::ReplyToFriendMessage(CSteamID steamIDFriend, const char *pchMsgToSend) {
  debug("ISteamFriends::ReplyToFriendMessage()");
  return true;
}
int ISteamFriends::GetFriendMessage(CSteamID steamIDFriend, int iMessageID, void *pvData, int cubData, EChatEntryType *peChatEntryType) {
...
bool ISteamRemoteStorage::GetUGCDetails(UGCHandle_t hContent, AppId_t *pnAppID, char **ppchName, int32_t *pnFileSizeInBytes, CSteamID *pSteamIDOwner) {
...
SteamAPICall_t ISteamRemoteStorage::EnumerateUserSharedWorkshopFiles(CSteamID steamId, uint32_t unStartIndex, struct SteamParamStringArray_t *pRequiredTags, struct SteamParamStringArray_t *pExcludedTags) {
...
void     ISteamMatchmaking::AddRequestLobbyListCompatibleMembersFilter(CSteamID steamIDLobby) { debug("ISteamMatchmaking::AddRequestLobbyListCompatibleMembersFilter"); }
...
void ISteamMatchmaking::LeaveLobby(CSteamID steamIDLobby) { debug("ISteamMatchmaking::LeaveLobby"); }
...
void ISteamMatchmaking::SetLobbyMemberData(CSteamID steamIDLobby, const char *pchKey, const char *pchValue) { debug("ISteamMatchmaking::SetLobbyMemberData"); }
...
void ISteamMatchmaking::SetLobbyGameServer(CSteamID steamIDLobby, uint32 unGameServerIP, uint16 unGameServerPort, CSteamID steamIDGameServer) { debug("ISteamMatchmaking::SetLobbyGameServer"); }
bool ISteamMatchmaking::GetLobbyGameServer(CSteamID steamIDLobby, uint32 *punGameServerIP, uint16 *punGameServerPort, CSteamID *psteamIDGameServer) {
...
bool ISteamNetworking::SendP2PPacket(CSteamID steamIDRemote, const void *pubData, uint32 cubData, EP2PSend eP2PSendType, int nChannel) {
...
bool ISteamNetworking::ReadP2PPacket(void *pubDest, uint32 cubDest, uint32 *pcubMsgSize, CSteamID *psteamIDRemote, int nChannel) {
...
bool ISteamNetworking::GetP2PSessionState(CSteamID steamIDRemote, struct P2PSessionState_t *pConnectionState) {
...
bool ISteamNetworking::GetSocketInfo(SNetSocket_t hSocket, CSteamID *pSteamIDRemote, int *peSocketStatus, uint32 *punIPRemote, uint16 *punPortRemote) {
...
bool ISteamInventory::CheckResultSteamID(SteamInventoryResult_t resultHandle, CSteamID steamIDExpected) {
...
bool ISteamInventory::TradeItems(SteamInventoryResult_t *pResultHandle, CSteamID steamIDTradePartner, const SteamItemInstanceID_t *pArrayGive, const uint32 *pArrayGiveQuantity, uint32 nArrayGiveLength, const SteamItemInstanceID_t *pArrayGet, const uint32 *pArrayGetQuantity, uint32 nArrayGetLength) {
...
SteamAPICall_t ISteamInventory::RequestEligiblePromoItemDefinitionsIDs(CSteamID steamID) {
  debug("ISteamInventory::RequestEligiblePromoItemDefinitionsIDs()");
  return {};
}
bool ISteamInventory::GetEligiblePromoItemDefinitionIDs(CSteamID steamID, SteamItemDef_t *pItemDefIDs, uint32 *punItemDefIDsArraySize) {
...
bool ISteamGameServer::SendUserConnectAndAuthenticate(uint32 unIPClient, const void *pvAuthBlob, uint32 cubAuthBlobSize, CSteamID *pSteamIDUser) {
...
void ISteamGameServer::SendUserDisconnect(CSteamID steamIDUser) { debug("ISteamGameServer::SendUserDisconnect()"); }
bool ISteamGameServer::BUpdateUserData(CSteamID steamIDUser, const char *pchPlayerName, uint32 uScore) {
...
void                        ISteamGameServer::EndAuthSession(CSteamID steamID) { debug("ISteamGameServer::EndAuthSession()"); }
...
bool ISteamGameServerStats::GetUserStat(CSteamID steamIDUser, const char *pchName, int32 *pData) {
  debug("ISteamGameServerStats::GetUserStat()");
  return true;
}
bool ISteamGameServerStats::GetUserStat(CSteamID steamIDUser, const char *pchName, float *pData) {
  debug("ISteamGameServerStats::GetUserStat()");
  return true;
}
bool ISteamGameServerStats::GetUserAchievement(CSteamID steamIDUser, const char *pchName, bool *pbAchieved) {
  debug("ISteamGameServerStats::GetUserAchievement()");
  return true;
}
bool ISteamGameServerStats::SetUserStat(CSteamID steamIDUser, const char *pchName, int32 nData) {
  debug("ISteamGameServerStats::SetUserStat()");
  return true;
}
bool ISteamGameServerStats::SetUserStat(CSteamID steamIDUser, const char *pchName, float fData) {
  debug("ISteamGameServerStats::SetUserStat()");
  return true;
}
bool ISteamGameServerStats::UpdateUserAvgRateStat(CSteamID steamIDUser, const char *pchName, float flCountThisSession, double dSessionLength) {
  debug("ISteamGameServerStats::UpdateUserAvgRateStat()");
  return true;
}
bool ISteamGameServerStats::SetUserAchievement(CSteamID steamIDUser, const char *pchName) {
  debug("ISteamGameServerStats::SetUserAchievement()");
  return true;
}
bool ISteamGameServerStats::ClearUserAchievement(CSteamID steamIDUser, const char *pchName) {
