...
ISteamMatchmaking *                  SteamMatchmaking() { return SteamContext.SteamMatchmaking(); }
ISteamUserStats *                    SteamUserStats() { return SteamContext.SteamUserStats(); }
ISteamApps *                         SteamApps() { return SteamContext.SteamApps(); }
ISteamMatchmakingServers *           SteamMatchmakingServers() { return SteamContext.SteamMatchmakingServers(); }
ISteamNetworking *                   SteamNetworking() { return SteamContext.SteamNetworking(); }
ISteamRemoteStorage *                SteamRemoteStorage() { return SteamContext.SteamRemoteStorage(); }
ISteamScreenshots *                  SteamScreenshots() { return SteamContext.SteamScreenshots(); }
...
ISteamMusicRemote *                  SteamMusicRemote() { return SteamContext.SteamMusicRemote(); }
ISteamHTMLSurface *                  SteamHTMLSurface() { return SteamContext.SteamHTMLSurface(); }
ISteamInventory *                    SteamInventory() { return SteamContext.SteamInventory(); }
ISteamVideo *                        SteamVideo() { return SteamContext.SteamVideo(); }
ISteamParentalSettings *             SteamParentalSettings() { return SteamContext.SteamParentalSettings(); }
ISteamGameServer *                   SteamGameServer() { return SteamContext.SteamGameServer(); }
ISteamGameServerStats *              SteamGameServerStats() { return SteamContext.SteamGameServerStats(); }
ISteamMatchmakingServerListResponse *SteamMatchmakingServerListResponse() { return SteamContext.SteamMatchmakingServerListResponse(); }
ISteamMatchmakingPingResponse *      SteamMatchmakingPingResponse() { return SteamContext.SteamMatchmakingPingResponse(); }
ISteamMatchmakingPlayersResponse *   SteamMatchmakingPlayersResponse() { return SteamContext.SteamMatchmakingPlayersResponse(); }
ISteamMatchmakingRulesResponse *     SteamMatchmakingRulesResponse() { return SteamContext.SteamMatchmakingRulesResponse(); }
...
int ISteamUser::InitiateGameConnection(void *pAuthBlob, int cbMaxAuthBlob, CSteamID steamIDGameServer, uint32_t unIPServer, uint16_t usPortServer, bool bSecure) {
  debug("ISteamUser::InitiateGameConnection()");
  return true;
}
void ISteamUser::TerminateGameConnection(uint32_t unIPServer, uint16_t usPortServer) {
...
EVoiceResult ISteamUser::GetAvailableVoice(uint32_t *pcbCompressed, uint32_t *pcbUncompressed_Deprecated = 0, uint32_t nUncompressedVoiceDesiredSampleRate_Deprecated = 0) {
  debug("ISteamUser::GetAvailableVoice()");
  return k_EVoiceResultOK;
}
EVoiceResult ISteamUser::GetVoice(bool bWantCompressed, void *pDestBuffer, uint32_t cbDestBufferSize, uint32_t *nBytesWritten, bool bWantUncompressed_Deprecated = false, void *pUncompressedDestBuffer_Deprecated = 0, uint32_t cbUncompressedDestBufferSize_Deprecated = 0, uint32_t *nUncompressBytesWritten_Deprecated = 0, uint32_t nUncompressedVoiceDesiredSampleRate_Deprecated = 0) {
  debug("ISteamUser::GetVoice()");
  return k_EVoiceResultOK;
}
EVoiceResult ISteamUser::DecompressVoice(const void *pCompressed, uint32_t cbCompressed, void *pDestBuffer, uint32_t cbDestBufferSize, uint32_t *nBytesWritten, uint32_t nDesiredSampleRate) {
...
HAuthTicket ISteamUser::GetAuthSessionTicket(void *pTicket, int cbMaxTicket, uint32_t *pcbTicket) {
...
EUserHasLicenseForAppResult ISteamUser::UserHasLicenseForApp(CSteamID steamID, AppId_t appID) {
...
void ISteamUser::AdvertiseGame(CSteamID steamIDGameServer, uint32_t unIPServer, uint16_t usPortServer) {
  debug("ISteamUser::AdvertiseGame()");
}
SteamAPICall_t ISteamUser::RequestEncryptedAppTicket(void *pDataToInclude, int cbDataToInclude) {
  debug("ISteamUser::RequestEncryptedAppTicket()");
  return true;
}
bool ISteamUser::GetEncryptedAppTicket(void *pTicket, int cbMaxTicket, uint32_t *pcbTicket) {
...
bool ISteamUtils::GetImageSize(int iImage, uint32_t *pnWidth, uint32_t *pnHeight) {
...
bool ISteamUtils::ShowGamepadTextInput(EGamepadTextInputMode eInputMode, EGamepadTextInputLineMode eLineInputMode, const char *pchDescription, uint32_t unCharMax, const char *pchExistingText) {
...
void ISteamUtils::SetOverlayNotificationInset(int nHorizontalInset, int nVerticalInset) {
...
bool ISteamUserStats::GetAchievementAndUnlockTime(const char *pchName, bool *pbAchieved, uint32_t *punUnlockTime) {
...
bool ISteamUserStats::IndicateAchievementProgress(const char *pchName, uint32_t nCurProgress, uint32_t nMaxProgress) {
...
bool ISteamUserStats::GetUserStat(CSteamID steamIDUser, const char *pchName, int32_t *pData) {
...
bool ISteamUserStats::GetUserAchievementAndUnlockTime(CSteamID steamIDUser, const char *pchName, bool *pbAchieved, uint32_t *punUnlockTime) {
...
bool ISteamUserStats::GetDownloadedLeaderboardEntry(SteamLeaderboardEntries_t hSteamLeaderboardEntries, int index, LeaderboardEntry_t *pLeaderboardEntry, int32_t *pDetails, int cDetailsMax) {
  debug("ISteamUserStats::GetDownloadedLeaderboardEntry()");
  return true;
}
SteamAPICall_t ISteamUserStats::UploadLeaderboardScore(SteamLeaderboard_t hSteamLeaderboard, ELeaderboardUploadScoreMethod eLeaderboardUploadScoreMethod, int32_t nScore, const int32_t *pScoreDetails, int cScoreDetailsCount) {
...
int ISteamUserStats::GetMostAchievedAchievementInfo(char *pchName, uint32_t unNameBufLen, float *pflPercent, bool *pbAchieved) {
  debug("ISteamUserStats::GetMostAchievedAchievementInfo()");
  return true;
}
int ISteamUserStats::GetNextMostAchievedAchievementInfo(int iIteratorPrevious, char *pchName, uint32_t unNameBufLen, float *pflPercent, bool *pbAchieved) {
...
int32_t ISteamUserStats::GetGlobalStatHistory(const char *pchStatName, int64 *pData, uint32 cubData) {
  debug("ISteamUserStats::GetGlobalStatHistory()");
  return true;
}
int32_t ISteamUserStats::GetGlobalStatHistory(const char *pchStatName, double *pData, uint32_t cubData) {
  debug("ISteamUserStats::GetGlobalStatHistory()");
  return true;
}
...
uint32_t ISteamApps::GetInstalledDepots(AppId_t appID, DepotId_t *pvecDepots, uint32_t cMaxDepots) {
  debug("ISteamApps::GetInstalledDepots()");
  return true;
}
uint32_t ISteamApps::GetAppInstallDir(AppId_t appID, char *pchFolder, uint32_t cchFolderBufferSize) {
...
bool ISteamApps::GetDlcDownloadProgress(AppId_t nAppID, uint64 *punBytesDownloaded, uint64 *punBytesTotal) {
...
EFriendRelationship ISteamFriends::GetFriendRelationship(class CSteamID steamIDFriend) {
  debug("ISteamFriends::GetFriendRelationship()");
  return k_EFriendRelationshipNone;
}
EPersonaState ISteamFriends::GetFriendPersonaState(class CSteamID steamIDFriend) {
...
bool ISteamFriends::GetFriendGamePlayed(class CSteamID steamIDFriend, struct FriendGameInfo_t *pFriendGameInfo) {
  debug("ISteamFriends::GetFriendGamePlayed()");
  return true;
}
const char *ISteamFriends::GetFriendPersonaNameHistory(class CSteamID steamIDFriend, int iPersonaName) {
...
const char *ISteamFriends::GetFriendsGroupName(FriendsGroupID_t friendsGroupID) {
  debug("ISteamFriends::GetFriendsGroupName()");
  return "";
}
int ISteamFriends::GetFriendsGroupMembersCount(FriendsGroupID_t friendsGroupID) {
  debug("ISteamFriends::GetFriendsGroupMembersCount()");
  return true;
}
void ISteamFriends::GetFriendsGroupMembersList(FriendsGroupID_t friendsGroupID, class CSteamID *pOutSteamIDMembers, int nMembersCount) {
...
bool ISteamFriends::GetClanActivityCounts(class CSteamID steamIDClan, int *pnOnline, int *pnInGame, int *pnChatting) {
  debug("ISteamFriends::GetClanActivityCounts()");
  return true;
}
SteamAPICall_t ISteamFriends::DownloadClanActivityCounts(class CSteamID *psteamIDClans, int cClansToRequest) {
...
uint64 ISteamFriends::GetFriendFromSourceByIndex(class CSteamID steamIDSource, int iFriend) {
  debug("ISteamFriends::GetFriendFromSourceByIndex()");
  return steam_id.m_steamid.m_unAll64Bits;
}
bool ISteamFriends::IsUserInSource(class CSteamID steamIDUser, class CSteamID steamIDSource) {
  debug("ISteamFriends::IsUserInSource()");
  return true;
}
void ISteamFriends::SetInGameVoiceSpeaking(class CSteamID steamIDUser, bool bSpeaking) {
...
void ISteamFriends::ActivateGameOverlayToUser(const char *pchDialog, class CSteamID steamID) {
...
void ISteamFriends::ActivateGameOverlayToStore(AppId_t nAppID, EOverlayToStoreFlag eFlag) {
...
void ISteamFriends::ActivateGameOverlayInviteDialog(class CSteamID steamIDLobby) {
...
bool ISteamFriends::RequestUserInformation(class CSteamID steamIDUser, bool bRequireNameOnly) {
  debug("ISteamFriends::RequestUserInformation()");
  return true;
}
SteamAPICall_t ISteamFriends::RequestClanOfficerList(class CSteamID steamIDClan) {
...
uint64 ISteamFriends::GetClanOfficerByIndex(class CSteamID steamIDClan, int iOfficer) {
...
const char *ISteamFriends::GetFriendRichPresence(class CSteamID steamIDFriend, const char *pchKey) {
...
const char *ISteamFriends::GetFriendRichPresenceKeyByIndex(class CSteamID steamIDFriend, int iKey) {
...
bool ISteamFriends::InviteUserToGame(class CSteamID steamIDFriend, const char *pchConnectString) {
...
uint64 ISteamFriends::GetChatMemberByIndex(class CSteamID steamIDClan, int iUser) {
  debug("ISteamFriends::GetChatMemberByIndex()");
  return steam_id.m_steamid.m_unAll64Bits;
}
bool ISteamFriends::SendClanChatMessage(class CSteamID steamIDClanChat, const char *pchText) {
  debug("ISteamFriends::SendClanChatMessage()");
  return true;
}
int ISteamFriends::GetClanChatMessage(class CSteamID steamIDClanChat, int iMessage, void *prgchText, int cchTextMax, EChatEntryType *peChatEntryType, class CSteamID *psteamidChatter) {
  debug("ISteamFriends::GetClanChatMessage()");
  return true;
}
bool ISteamFriends::IsClanChatAdmin(class CSteamID steamIDClanChat, class CSteamID steamIDUser) {
  debug("ISteamFriends::IsClanChatAdmin()");
  return true;
}
bool ISteamFriends::IsClanChatWindowOpenInSteam(class CSteamID steamIDClanChat) {
...
bool ISteamFriends::ReplyToFriendMessage(class CSteamID steamIDFriend, const char *pchMsgToSend) {
  debug("ISteamFriends::ReplyToFriendMessage()");
  return true;
}
int ISteamFriends::GetFriendMessage(class CSteamID steamIDFriend, int iMessageID, void *pvData, int cubData, EChatEntryType *peChatEntryType) {
...
bool ISteamRemoteStorage::FileWrite(const char *pchFile, const void *pvData, int32_t cubData) {
  debug("ISteamRemoteStorage::FileWrite()");
  return true;
}
int32_t ISteamRemoteStorage::FileRead(const char *pchFile, void *pvData, int32_t cubDataToRead) {
  debug("ISteamRemoteStorage::FileRead()");
  return true;
}
SteamAPICall_t ISteamRemoteStorage::FileWriteAsync(const char *pchFile, const void *pvData, uint32_t cubData) {
  debug("ISteamRemoteStorage::FileWriteAsync()");
  return true;
}
SteamAPICall_t ISteamRemoteStorage::FileReadAsync(const char *pchFile, uint32_t nOffset, uint32_t cubToRead) {
  debug("ISteamRemoteStorage::FileReadAsync()");
  return true;
}
bool ISteamRemoteStorage::FileReadAsyncComplete(SteamAPICall_t hReadCall, void *pvBuffer, uint32_t cubToRead) {
...
bool ISteamRemoteStorage::FileWriteStreamWriteChunk(UGCFileWriteStreamHandle_t writeHandle, const void *pvData, int32_t cubData) {
...
const char *ISteamRemoteStorage::GetFileNameAndSize(int iFile, int32_t *pnFileSizeInBytes) {
...
SteamAPICall_t ISteamRemoteStorage::UGCDownload(UGCHandle_t hContent, uint32_t unPriority) {
  debug("ISteamRemoteStorage::UGCDownload()");
  return true;
}
bool ISteamRemoteStorage::GetUGCDownloadProgress(UGCHandle_t hContent, int32_t *pnBytesDownloaded, int32_t *pnBytesExpected) {
  debug("ISteamRemoteStorage::GetUGCDownloadProgress()");
  return true;
}
bool ISteamRemoteStorage::GetUGCDetails(UGCHandle_t hContent, AppId_t *pnAppID, char **ppchName, int32_t *pnFileSizeInBytes, class CSteamID *pSteamIDOwner) {
  debug("ISteamRemoteStorage::GetUGCDetails()");
  return true;
}
int32_t ISteamRemoteStorage::UGCRead(UGCHandle_t hContent, void *pvData, int32_t cubDataToRead, uint32_t cOffset, EUGCReadAction eAction) {
...
SteamAPICall_t ISteamRemoteStorage::PublishWorkshopFile(const char *pchFile, const char *pchPreviewFile, AppId_t nConsumerAppId, const char *pchTitle, const char *pchDescription, ERemoteStoragePublishedFileVisibility eVisibility, struct SteamParamStringArray_t *pTags, EWorkshopFileType eWorkshopFileType) {
  debug("ISteamRemoteStorage::PublishWorkshopFile()");
  return true;
}
PublishedFileUpdateHandle_t ISteamRemoteStorage::CreatePublishedFileUpdateRequest(PublishedFileId_t unPublishedFileId) {
  debug("ISteamRemoteStorage::CreatePublishedFileUpdateRequest()");
  return true;
}
bool ISteamRemoteStorage::UpdatePublishedFileFile(PublishedFileUpdateHandle_t updateHandle, const char *pchFile) {
  debug("ISteamRemoteStorage::UpdatePublishedFileFile()");
  return true;
}
bool ISteamRemoteStorage::UpdatePublishedFilePreviewFile(PublishedFileUpdateHandle_t updateHandle, const char *pchPreviewFile) {
  debug("ISteamRemoteStorage::UpdatePublishedFilePreviewFile()");
  return true;
}
bool ISteamRemoteStorage::UpdatePublishedFileTitle(PublishedFileUpdateHandle_t updateHandle, const char *pchTitle) {
  debug("ISteamRemoteStorage::UpdatePublishedFileTitle()");
  return true;
}
bool ISteamRemoteStorage::UpdatePublishedFileDescription(PublishedFileUpdateHandle_t updateHandle, const char *pchDescription) {
  debug("ISteamRemoteStorage::UpdatePublishedFileDescription()");
  return true;
}
bool ISteamRemoteStorage::UpdatePublishedFileVisibility(PublishedFileUpdateHandle_t updateHandle, ERemoteStoragePublishedFileVisibility eVisibility) {
  debug("ISteamRemoteStorage::UpdatePublishedFileVisibility()");
  return true;
}
bool ISteamRemoteStorage::UpdatePublishedFileTags(PublishedFileUpdateHandle_t updateHandle, struct SteamParamStringArray_t *pTags) {
  debug("ISteamRemoteStorage::UpdatePublishedFileTags()");
  return true;
}
SteamAPICall_t ISteamRemoteStorage::CommitPublishedFileUpdate(PublishedFileUpdateHandle_t updateHandle) {
  debug("ISteamRemoteStorage::CommitPublishedFileUpdate()");
  return true;
}
SteamAPICall_t ISteamRemoteStorage::GetPublishedFileDetails(PublishedFileId_t unPublishedFileId, uint32_t unMaxSecondsOld) {
  debug("ISteamRemoteStorage::GetPublishedFileDetails()");
  return true;
}
SteamAPICall_t ISteamRemoteStorage::DeletePublishedFile(PublishedFileId_t unPublishedFileId) {
  debug("ISteamRemoteStorage::DeletePublishedFile()");
  return true;
}
SteamAPICall_t ISteamRemoteStorage::EnumerateUserPublishedFiles(uint32_t unStartIndex) {
  debug("ISteamRemoteStorage::EnumerateUserPublishedFiles()");
  return true;
}
SteamAPICall_t ISteamRemoteStorage::SubscribePublishedFile(PublishedFileId_t unPublishedFileId) {
  debug("ISteamRemoteStorage::SubscribePublishedFile()");
  return true;
}
SteamAPICall_t ISteamRemoteStorage::EnumerateUserSubscribedFiles(uint32_t unStartIndex) {
  debug("ISteamRemoteStorage::EnumerateUserSubscribedFiles()");
  return true;
}
SteamAPICall_t ISteamRemoteStorage::UnsubscribePublishedFile(PublishedFileId_t unPublishedFileId) {
  debug("ISteamRemoteStorage::UnsubscribePublishedFile()");
  return true;
}
bool ISteamRemoteStorage::UpdatePublishedFileSetChangeDescription(PublishedFileUpdateHandle_t updateHandle, const char *pchChangeDescription) {
  debug("ISteamRemoteStorage::UpdatePublishedFileSetChangeDescription()");
  return true;
}
SteamAPICall_t ISteamRemoteStorage::GetPublishedItemVoteDetails(PublishedFileId_t unPublishedFileId) {
  debug("ISteamRemoteStorage::GetPublishedItemVoteDetails()");
  return true;
}
SteamAPICall_t ISteamRemoteStorage::UpdateUserPublishedItemVote(PublishedFileId_t unPublishedFileId, bool bVoteUp) {
  debug("ISteamRemoteStorage::UpdateUserPublishedItemVote()");
  return true;
}
SteamAPICall_t ISteamRemoteStorage::GetUserPublishedItemVoteDetails(PublishedFileId_t unPublishedFileId) {
  debug("ISteamRemoteStorage::GetUserPublishedItemVoteDetails()");
  return true;
}
SteamAPICall_t ISteamRemoteStorage::EnumerateUserSharedWorkshopFiles(class CSteamID steamId, uint32_t unStartIndex, struct SteamParamStringArray_t *pRequiredTags, struct SteamParamStringArray_t *pExcludedTags) {
  debug("ISteamRemoteStorage::EnumerateUserSharedWorkshopFiles()");
  return true;
}
SteamAPICall_t ISteamRemoteStorage::PublishVideo(EWorkshopVideoProvider eVideoProvider, const char *pchVideoAccount, const char *pchVideoIdentifier, const char *pchPreviewFile, AppId_t nConsumerAppId, const char *pchTitle, const char *pchDescription, ERemoteStoragePublishedFileVisibility eVisibility, struct SteamParamStringArray_t *pTags) {
  debug("ISteamRemoteStorage::PublishVideo()");
  return true;
}
SteamAPICall_t ISteamRemoteStorage::SetUserPublishedFileAction(PublishedFileId_t unPublishedFileId, EWorkshopFileAction eAction) {
  debug("ISteamRemoteStorage::SetUserPublishedFileAction()");
  return true;
}
SteamAPICall_t ISteamRemoteStorage::EnumeratePublishedFilesByUserAction(EWorkshopFileAction eAction, uint32_t unStartIndex) {
  debug("ISteamRemoteStorage::EnumeratePublishedFilesByUserAction()");
  return true;
}
SteamAPICall_t ISteamRemoteStorage::EnumeratePublishedWorkshopFiles(EWorkshopEnumerationType eEnumerationType, uint32_t unStartIndex, uint32_t unCount, uint32_t unDays, struct SteamParamStringArray_t *pTags, struct SteamParamStringArray_t *pUserTags) {
  debug("ISteamRemoteStorage::EnumeratePublishedWorkshopFiles()");
  return true;
}
SteamAPICall_t ISteamRemoteStorage::UGCDownloadToLocation(UGCHandle_t hContent, const char *pchLocation, uint32_t unPriority) {
...
extern "C" void SteamInternal_ContextInit() { debug("SteamInternal_ContextInit()"); }
...
extern "C" void SteamGameServer_RunCallbacks() { debug("SteamGameServer_RunCallbacks"); }
extern "C" void SteamAPI_RegisterCallResult(void *pCallback, SteamAPICall_t callback) { debug("SteamAPI_RegisterCallResult"); }
extern "C" void SteamAPI_UnregisterCallResult(void *pCallback, SteamAPICall_t callback) { debug("SteamAPI_UnregisterCallResult"); }
...
void ISteamHTMLSurface::DestructISteamHTMLSurface() { debug("ISteamHTMLSurface::DestructISteamHTMLSurface()"); }
...
SteamAPICall_t ISteamHTMLSurface::CreateBrowser(const char *pchUserAgent, const char *pchUserCSS) {
  debug("ISteamHTMLSurface::CreateBrowser()");
  return {};
}
void ISteamHTMLSurface::RemoveBrowser(HHTMLBrowser unBrowserHandle) { debug("ISteamHTMLSurface::RemoveBrowser()"); }
void ISteamHTMLSurface::LoadURL(HHTMLBrowser unBrowserHandle, const char *pchURL, const char *pchPostData) { debug("ISteamHTMLSurface::LoadURL()"); }
void ISteamHTMLSurface::SetSize(HHTMLBrowser unBrowserHandle, uint32 unWidth, uint32 unHeight) { debug("ISteamHTMLSurface::SetSize()"); }
void ISteamHTMLSurface::StopLoad(HHTMLBrowser unBrowserHandle) { debug("ISteamHTMLSurface::StopLoad()"); }
void ISteamHTMLSurface::Reload(HHTMLBrowser unBrowserHandle) { debug("ISteamHTMLSurface::Reload()"); }
void ISteamHTMLSurface::GoBack(HHTMLBrowser unBrowserHandle) { debug("ISteamHTMLSurface::GoBack()"); }
void ISteamHTMLSurface::GoForward(HHTMLBrowser unBrowserHandle) { debug("ISteamHTMLSurface::GoForward()"); }
void ISteamHTMLSurface::AddHeader(HHTMLBrowser unBrowserHandle, const char *pchKey, const char *pchValue) { debug("ISteamHTMLSurface::AddHeader()"); }
void ISteamHTMLSurface::ExecuteJavascript(HHTMLBrowser unBrowserHandle, const char *pchScript) { debug("ISteamHTMLSurface::ExecuteJavascript()"); }
void ISteamHTMLSurface::MouseUp(HHTMLBrowser unBrowserHandle, ISteamHTMLSurface::EHTMLMouseButton eMouseButton) { debug("ISteamHTMLSurface::MouseUp()"); }
void ISteamHTMLSurface::MouseDown(HHTMLBrowser unBrowserHandle, ISteamHTMLSurface::EHTMLMouseButton eMouseButton) { debug("ISteamHTMLSurface::MouseDown()"); }
void ISteamHTMLSurface::MouseDoubleClick(HHTMLBrowser unBrowserHandle, ISteamHTMLSurface::EHTMLMouseButton eMouseButton) { debug("ISteamHTMLSurface::MouseDoubleClick()"); }
void ISteamHTMLSurface::MouseMove(HHTMLBrowser unBrowserHandle, int x, int y) { debug("ISteamHTMLSurface::MouseMove()"); }
void ISteamHTMLSurface::MouseWheel(HHTMLBrowser unBrowserHandle, int32 nDelta) { debug("ISteamHTMLSurface::MouseWheel()"); }
void ISteamHTMLSurface::KeyDown(HHTMLBrowser unBrowserHandle, uint32 nNativeKeyCode, ISteamHTMLSurface::EHTMLKeyModifiers eHTMLKeyModifiers) { debug("ISteamHTMLSurface::KeyDown()"); }
void ISteamHTMLSurface::KeyUp(HHTMLBrowser unBrowserHandle, uint32 nNativeKeyCode, ISteamHTMLSurface::EHTMLKeyModifiers eHTMLKeyModifiers) { debug("ISteamHTMLSurface::KeyUp()"); }
void ISteamHTMLSurface::KeyChar(HHTMLBrowser unBrowserHandle, uint32 cUnicodeChar, ISteamHTMLSurface::EHTMLKeyModifiers eHTMLKeyModifiers) { debug("ISteamHTMLSurface::KeyChar()"); }
void ISteamHTMLSurface::SetHorizontalScroll(HHTMLBrowser unBrowserHandle, uint32 nAbsolutePixelScroll) { debug("ISteamHTMLSurface::SetHorizontalScroll()"); }
void ISteamHTMLSurface::SetVerticalScroll(HHTMLBrowser unBrowserHandle, uint32 nAbsolutePixelScroll) { debug("ISteamHTMLSurface::SetVerticalScroll()"); }
void ISteamHTMLSurface::SetKeyFocus(HHTMLBrowser unBrowserHandle, bool bHasKeyFocus) { debug("ISteamHTMLSurface::SetKeyFocus()"); }
void ISteamHTMLSurface::ViewSource(HHTMLBrowser unBrowserHandle) { debug("ISteamHTMLSurface::ViewSource()"); }
void ISteamHTMLSurface::CopyToClipboard(HHTMLBrowser unBrowserHandle) { debug("ISteamHTMLSurface::CopyToClipboard()"); }
void ISteamHTMLSurface::PasteFromClipboard(HHTMLBrowser unBrowserHandle) { debug("ISteamHTMLSurface::PasteFromClipboard()"); }
void ISteamHTMLSurface::Find(HHTMLBrowser unBrowserHandle, const char *pchSearchStr, bool bCurrentlyInFind, bool bReverse) { debug("ISteamHTMLSurface::Find()"); }
void ISteamHTMLSurface::StopFind(HHTMLBrowser unBrowserHandle) { debug("ISteamHTMLSurface::StopFind()"); }
void ISteamHTMLSurface::GetLinkAtPosition(HHTMLBrowser unBrowserHandle, int x, int y) { debug("ISteamHTMLSurface::GetLinkAtPosition()"); }
void ISteamHTMLSurface::SetCookie(const char *pchHostname, const char *pchKey, const char *pchValue, const char *pchPath, RTime32 nExpires, bool bSecure, bool bHTTPOnly) { debug("ISteamHTMLSurface::SetCookie()"); }
void ISteamHTMLSurface::SetPageScaleFactor(HHTMLBrowser unBrowserHandle, float flZoom, int nPointX, int nPointY) { debug("ISteamHTMLSurface::SetPageScaleFactor()"); }
void ISteamHTMLSurface::SetBackgroundMode(HHTMLBrowser unBrowserHandle, bool bBackgroundMode) { debug("ISteamHTMLSurface::SetBackgroundMode()"); }
void ISteamHTMLSurface::SetDPIScalingFactor(HHTMLBrowser unBrowserHandle, float flDPIScaling) { debug("ISteamHTMLSurface::SetDPIScalingFactor()"); }
void ISteamHTMLSurface::AllowStartRequest(HHTMLBrowser unBrowserHandle, bool bAllowed) { debug("ISteamHTMLSurface::AllowStartRequest()"); }
void ISteamHTMLSurface::JSDialogResponse(HHTMLBrowser unBrowserHandle, bool bResult) { debug("ISteamHTMLSurface::JSDialogResponse()"); }

int ISteamMatchmaking::GetFavoriteGameCount() {
  debug("ISteamMatchmaking::GetFavoriteGameCount");
  return 0;
}
bool ISteamMatchmaking::GetFavoriteGame(int iGame, AppId_t *pnAppID, uint32 *pnIP, uint16 *pnConnPort, uint16 *pnQueryPort, uint32 *punFlags, uint32 *pRTime32LastPlayedOnServer) {
  debug("ISteamMatchmaking::GetFavoriteGame");
  return true;
}
int ISteamMatchmaking::AddFavoriteGame(AppId_t nAppID, uint32 nIP, uint16 nConnPort, uint16 nQueryPort, uint32 unFlags, uint32 rTime32LastPlayedOnServer) {
  debug("ISteamMatchmaking::AddFavoriteGame");
  return 0;
}
bool ISteamMatchmaking::RemoveFavoriteGame(AppId_t nAppID, uint32 nIP, uint16 nConnPort, uint16 nQueryPort, uint32 unFlags) {
...
void   ISteamMatchmaking::AddRequestLobbyListStringFilter(const char *pchKeyToMatch, const char *pchValueToMatch, ELobbyComparison eComparisonType) { debug("ISteamMatchmaking::AddRequestLobbyListStringFilter"); }
void   ISteamMatchmaking::AddRequestLobbyListNumericalFilter(const char *pchKeyToMatch, int nValueToMatch, ELobbyComparison eComparisonType) { debug("ISteamMatchmaking::AddRequestLobbyListNumericalFilter"); }
void   ISteamMatchmaking::AddRequestLobbyListNearValueFilter(const char *pchKeyToMatch, int nValueToBeCloseTo) { debug("ISteamMatchmaking::AddRequestLobbyListNearValueFilter"); }
void   ISteamMatchmaking::AddRequestLobbyListFilterSlotsAvailable(int nSlotsAvailable) { debug("ISteamMatchmaking::AddRequestLobbyListFilterSlotsAvailable"); }
void   ISteamMatchmaking::AddRequestLobbyListDistanceFilter(ELobbyDistanceFilter eLobbyDistanceFilter) { debug("ISteamMatchmaking::AddRequestLobbyListDistanceFilter"); }
void   ISteamMatchmaking::AddRequestLobbyListResultCountFilter(int cMaxResults) { debug("ISteamMatchmaking::AddRequestLobbyListResultCountFilter"); }
void   ISteamMatchmaking::AddRequestLobbyListCompatibleMembersFilter(class CSteamID steamIDLobby) { debug("ISteamMatchmaking::AddRequestLobbyListCompatibleMembersFilter"); }
...
void ISteamMatchmaking::LeaveLobby(class CSteamID steamIDLobby) { debug("ISteamMatchmaking::LeaveLobby"); }
bool ISteamMatchmaking::InviteUserToLobby(class CSteamID steamIDLobby, class CSteamID steamIDInvitee) {
...
uint64 ISteamMatchmaking::GetLobbyMemberByIndex(class CSteamID steamIDLobby, int iMember) {
  debug("ISteamMatchmaking::GetLobbyMemberByIndex");
  return steam_id.m_steamid.m_unAll64Bits;
}
const char *ISteamMatchmaking::GetLobbyData(class CSteamID steamIDLobby, const char *pchKey) {
  debug("ISteamMatchmaking::GetLobbyData");
  return "";
}
bool ISteamMatchmaking::SetLobbyData(class CSteamID steamIDLobby, const char *pchKey, const char *pchValue) {
...
bool ISteamMatchmaking::GetLobbyDataByIndex(class CSteamID steamIDLobby, int iLobbyData, char *pchKey, int cchKeyBufferSize, char *pchValue, int cchValueBufferSize) {
  debug("ISteamMatchmaking::GetLobbyDataByIndex");
  return true;
}
bool ISteamMatchmaking::DeleteLobbyData(class CSteamID steamIDLobby, const char *pchKey) {
  debug("ISteamMatchmaking::DeleteLobbyData");
  return true;
}
const char *ISteamMatchmaking::GetLobbyMemberData(class CSteamID steamIDLobby, class CSteamID steamIDUser, const char *pchKey) {
  debug("ISteamMatchmaking::GetLobbyMemberData");
  return "";
}
void ISteamMatchmaking::SetLobbyMemberData(class CSteamID steamIDLobby, const char *pchKey, const char *pchValue) { debug("ISteamMatchmaking::SetLobbyMemberData"); }
bool ISteamMatchmaking::SendLobbyChatMsg(class CSteamID steamIDLobby, const void *pvMsgBody, int cubMsgBody) {
  debug("ISteamMatchmaking::SendLobbyChatMsg");
  return true;
}
int ISteamMatchmaking::GetLobbyChatEntry(class CSteamID steamIDLobby, int iChatID, class CSteamID *pSteamIDUser, void *pvData, int cubData, EChatEntryType *peChatEntryType) {
...
void ISteamMatchmaking::SetLobbyGameServer(class CSteamID steamIDLobby, uint32 unGameServerIP, uint16 unGameServerPort, class CSteamID steamIDGameServer) { debug("ISteamMatchmaking::SetLobbyGameServer"); }
bool ISteamMatchmaking::GetLobbyGameServer(class CSteamID steamIDLobby, uint32 *punGameServerIP, uint16 *punGameServerPort, class CSteamID *psteamIDGameServer) {
  debug("ISteamMatchmaking::GetLobbyGameServer");
  return true;
}
bool ISteamMatchmaking::SetLobbyMemberLimit(class CSteamID steamIDLobby, int cMaxMembers) {
...
bool ISteamMatchmaking::SetLobbyType(class CSteamID steamIDLobby, ELobbyType eLobbyType) {
  debug("ISteamMatchmaking::SetLobbyType");
  return true;
}
bool ISteamMatchmaking::SetLobbyJoinable(class CSteamID steamIDLobby, bool bLobbyJoinable) {
...
bool ISteamMatchmaking::SetLobbyOwner(class CSteamID steamIDLobby, class CSteamID steamIDNewOwner) {
  debug("ISteamMatchmaking::SetLobbyOwner");
  return true;
}
bool ISteamMatchmaking::SetLinkedLobby(class CSteamID steamIDLobby, class CSteamID steamIDLobbyDependent) {
  debug("ISteamMatchmaking::SetLinkedLobby");
  return true;
}

void ISteamMatchmakingServerListResponse::ServerResponded(HServerListRequest hRequest, int iServer) { debug("ISteamMatchmakingServerListResponse::ServerResponded()"); }
void ISteamMatchmakingServerListResponse::ServerFailedToRespond(HServerListRequest hRequest, int iServer) { debug("ISteamMatchmakingServerListResponse::ServerFailedToRespond()"); }
void ISteamMatchmakingServerListResponse::RefreshComplete(HServerListRequest hRequest, EMatchMakingServerResponse response) { debug("ISteamMatchmakingServerListResponse::RefreshComplete()"); }

void ISteamMatchmakingPingResponse::ServerResponded(class gameserveritem_t &server) { debug("ISteamMatchmakingPingResponse::ServerResponded()"); }
void ISteamMatchmakingPingResponse::ServerFailedToRespond() { debug("ISteamMatchmakingPingResponse::ServerFailedToRespond()"); }

void ISteamMatchmakingPlayersResponse::AddPlayerToList(const char *pchName, int nScore, float flTimePlayed) { debug("ISteamMatchmakingPlayersResponse::AddPlayerToList()"); }
void ISteamMatchmakingPlayersResponse::PlayersFailedToRespond() { debug("ISteamMatchmakingPlayersResponse::PlayersFailedToRespond()"); }
void ISteamMatchmakingPlayersResponse::PlayersRefreshComplete() { debug("ISteamMatchmakingPlayersResponse::PlayersRefreshComplete()"); }

void ISteamMatchmakingRulesResponse::RulesResponded(const char *pchRule, const char *pchValue) { debug("ISteamMatchmakingRulesResponse::RulesResponded()"); }
void ISteamMatchmakingRulesResponse::RulesFailedToRespond() { debug("ISteamMatchmakingRulesResponse::RulesFailedToRespond()"); }
void ISteamMatchmakingRulesResponse::RulesRefreshComplete() { debug("ISteamMatchmakingRulesResponse::RulesRefreshComplete()"); }

HServerListRequest ISteamMatchmakingServers::RequestInternetServerList(AppId_t iApp, struct MatchMakingKeyValuePair_t **ppchFilters, uint32 nFilters, class ISteamMatchmakingServerListResponse *pRequestServersResponse) {
  debug("ISteamMatchmakingServers::RequestInternetServerList()");
  return {};
}
HServerListRequest ISteamMatchmakingServers::RequestLANServerList(AppId_t iApp, class ISteamMatchmakingServerListResponse *pRequestServersResponse) {
  debug("ISteamMatchmakingServers::RequestLANServerList()");
  return {};
}
HServerListRequest ISteamMatchmakingServers::RequestFriendsServerList(AppId_t iApp, struct MatchMakingKeyValuePair_t **ppchFilters, uint32 nFilters, class ISteamMatchmakingServerListResponse *pRequestServersResponse) {
  debug("ISteamMatchmakingServers::RequestFriendsServerList()");
  return {};
}
HServerListRequest ISteamMatchmakingServers::RequestFavoritesServerList(AppId_t iApp, struct MatchMakingKeyValuePair_t **ppchFilters, uint32 nFilters, class ISteamMatchmakingServerListResponse *pRequestServersResponse) {
  debug("ISteamMatchmakingServers::RequestFavoritesServerList()");
  return {};
}
HServerListRequest ISteamMatchmakingServers::RequestHistoryServerList(AppId_t iApp, struct MatchMakingKeyValuePair_t **ppchFilters, uint32 nFilters, class ISteamMatchmakingServerListResponse *pRequestServersResponse) {
  debug("ISteamMatchmakingServers::RequestHistoryServerList()");
  return {};
}
HServerListRequest ISteamMatchmakingServers::RequestSpectatorServerList(AppId_t iApp, struct MatchMakingKeyValuePair_t **ppchFilters, uint32 nFilters, class ISteamMatchmakingServerListResponse *pRequestServersResponse) {
  debug("ISteamMatchmakingServers::RequestSpectatorServerList()");
  return {};
}
void              ISteamMatchmakingServers::ReleaseRequest(HServerListRequest hServerListRequest) { debug("ISteamMatchmakingServers::ReleaseRequest()"); }
...
void ISteamMatchmakingServers::CancelQuery(HServerListRequest hRequest) { debug("ISteamMatchmakingServers::CancelQuery()"); }
void ISteamMatchmakingServers::RefreshQuery(HServerListRequest hRequest) { debug("ISteamMatchmakingServers::RefreshQuery()"); }
...
void         ISteamMatchmakingServers::RefreshServer(HServerListRequest hRequest, int iServer) { debug("ISteamMatchmakingServers::RefreshServer()"); }
HServerQuery ISteamMatchmakingServers::PingServer(uint32 unIP, uint16 usPort, class ISteamMatchmakingPingResponse *pRequestServersResponse) {
  debug("ISteamMatchmakingServers::PingServer()");
  return {};
}
HServerQuery ISteamMatchmakingServers::PlayerDetails(uint32 unIP, uint16 usPort, class ISteamMatchmakingPlayersResponse *pRequestServersResponse) {
  debug("ISteamMatchmakingServers::PlayerDetails()");
  return {};
}
HServerQuery ISteamMatchmakingServers::ServerRules(uint32 unIP, uint16 usPort, class ISteamMatchmakingRulesResponse *pRequestServersResponse) {
  debug("ISteamMatchmakingServers::ServerRules()");
  return {};
}
void ISteamMatchmakingServers::CancelServerQuery(HServerQuery hServerQuery) { debug("ISteamMatchmakingServers::CancelServerQuery()"); }

bool ISteamNetworking::SendP2PPacket(class CSteamID steamIDRemote, const void *pubData, uint32 cubData, EP2PSend eP2PSendType, int nChannel) {
...
bool ISteamNetworking::ReadP2PPacket(void *pubDest, uint32 cubDest, uint32 *pcubMsgSize, class CSteamID *psteamIDRemote, int nChannel) {
...
bool ISteamNetworking::CloseP2PChannelWithUser(class CSteamID steamIDRemote, int nChannel) {
  debug("ISteamNetworking::CloseP2PChannelWithUser()");
  return true;
}
bool ISteamNetworking::GetP2PSessionState(class CSteamID steamIDRemote, struct P2PSessionState_t *pConnectionState) {
...
SNetListenSocket_t ISteamNetworking::CreateListenSocket(int nVirtualP2PPort, uint32 nIP, uint16 nPort, bool bAllowUseOfPacketRelay) {
  debug("ISteamNetworking::CreateListenSocket()");
  return {};
}
SNetSocket_t ISteamNetworking::CreateP2PConnectionSocket(class CSteamID steamIDTarget, int nVirtualPort, int nTimeoutSec, bool bAllowUseOfPacketRelay) {
  debug("ISteamNetworking::CreateP2PConnectionSocket()");
  return {};
}
SNetSocket_t ISteamNetworking::CreateConnectionSocket(uint32 nIP, uint16 nPort, int nTimeoutSec) {
...
bool ISteamNetworking::SendDataOnSocket(SNetSocket_t hSocket, void *pubData, uint32 cubData, bool bReliable) {
  debug("ISteamNetworking::SendDataOnSocket()");
  return true;
}
bool ISteamNetworking::IsDataAvailableOnSocket(SNetSocket_t hSocket, uint32 *pcubMsgSize) {
  debug("ISteamNetworking::IsDataAvailableOnSocket()");
  return true;
}
bool ISteamNetworking::RetrieveDataFromSocket(SNetSocket_t hSocket, void *pubDest, uint32 cubDest, uint32 *pcubMsgSize) {
  debug("ISteamNetworking::RetrieveDataFromSocket()");
  return true;
}
bool ISteamNetworking::IsDataAvailable(SNetListenSocket_t hListenSocket, uint32 *pcubMsgSize, SNetSocket_t *phSocket) {
  debug("ISteamNetworking::IsDataAvailable()");
  return true;
}
bool ISteamNetworking::RetrieveData(SNetListenSocket_t hListenSocket, void *pubDest, uint32 cubDest, uint32 *pcubMsgSize, SNetSocket_t *phSocket) {
  debug("ISteamNetworking::RetrieveData()");
  return true;
}
bool ISteamNetworking::GetSocketInfo(SNetSocket_t hSocket, class CSteamID *pSteamIDRemote, int *peSocketStatus, uint32 *punIPRemote, uint16 *punPortRemote) {
  debug("ISteamNetworking::GetSocketInfo()");
  return true;
}
bool ISteamNetworking::GetListenSocketInfo(SNetListenSocket_t hListenSocket, uint32 *pnIP, uint16 *pnPort) {
...
ScreenshotHandle ISteamScreenshots::WriteScreenshot(void *pubRGB, uint32 cubRGB, int nWidth, int nHeight) {
...
void ISteamScreenshots::TriggerScreenshot() { debug("ISteamScreenshots::TriggerScreenshot()"); }
void ISteamScreenshots::HookScreenshots(bool bHook) { debug("ISteamScreenshots::HookScreenshots()"); }
...
bool ISteamScreenshots::TagUser(ScreenshotHandle hScreenshot, class CSteamID steamID) {
...
void  ISteamMusic::SetVolume(float flVolume) { debug("ISteamMusic::SetVolume()"); }
...
bool ISteamMusicRemote::SetPNGIcon_64x64(void *pvBuffer, uint32 cbBufferLength) {
...
bool ISteamMusicRemote::UpdateCurrentEntryCoverArt(void *pvBuffer, uint32 cbBufferLength) {
...
bool ISteamMusicRemote::SetQueueEntry(int nID, int nPosition, const char *pchEntryText) {
...
bool ISteamMusicRemote::SetPlaylistEntry(int nID, int nPosition, const char *pchEntryText) {
...
bool ISteamHTTP::SetHTTPRequestContextValue(HTTPRequestHandle hRequest, uint64 ulContextValue) {
  debug("ISteamHTTP::SetHTTPRequestContextValue()");
  return true;
}
bool ISteamHTTP::SetHTTPRequestNetworkActivityTimeout(HTTPRequestHandle hRequest, uint32 unTimeoutSeconds) {
...
bool ISteamHTTP::GetHTTPResponseHeaderSize(HTTPRequestHandle hRequest, const char *pchHeaderName, uint32 *unResponseHeaderSize) {
  debug("ISteamHTTP::GetHTTPResponseHeaderSize()");
  return true;
}
bool ISteamHTTP::GetHTTPResponseHeaderValue(HTTPRequestHandle hRequest, const char *pchHeaderName, uint8 *pHeaderValueBuffer, uint32 unBufferSize) {
  debug("ISteamHTTP::GetHTTPResponseHeaderValue()");
  return true;
}
bool ISteamHTTP::GetHTTPResponseBodySize(HTTPRequestHandle hRequest, uint32 *unBodySize) {
  debug("ISteamHTTP::GetHTTPResponseBodySize()");
  return true;
}
bool ISteamHTTP::GetHTTPResponseBodyData(HTTPRequestHandle hRequest, uint8 *pBodyDataBuffer, uint32 unBufferSize) {
  debug("ISteamHTTP::GetHTTPResponseBodyData()");
  return true;
}
bool ISteamHTTP::GetHTTPStreamingResponseBodyData(HTTPRequestHandle hRequest, uint32 cOffset, uint8 *pBodyDataBuffer, uint32 unBufferSize) {
...
bool ISteamHTTP::SetHTTPRequestRawPostBody(HTTPRequestHandle hRequest, const char *pchContentType, uint8 *pubBody, uint32 unBodyLen) {
...
bool ISteamHTTP::SetHTTPRequestAbsoluteTimeoutMS(HTTPRequestHandle hRequest, uint32 unMilliseconds) {
...
void                        ISteamController::ActivateActionSet(ControllerHandle_t controllerHandle, ControllerActionSetHandle_t actionSetHandle) { debug("ISteamController::ActivateActionSet()"); }
...
void ISteamController::ActivateActionSetLayer(ControllerHandle_t controllerHandle, ControllerActionSetHandle_t actionSetLayerHandle) { debug("ISteamController::ActivateActionSetLayer()"); }
void ISteamController::DeactivateActionSetLayer(ControllerHandle_t controllerHandle, ControllerActionSetHandle_t actionSetLayerHandle) { debug("ISteamController::DeactivateActionSetLayer()"); }
void ISteamController::DeactivateAllActionSetLayers(ControllerHandle_t controllerHandle) { debug("ISteamController::DeactivateAllActionSetLayers()"); }
int  ISteamController::GetActiveActionSetLayers(ControllerHandle_t controllerHandle, ControllerActionSetHandle_t *handlesOut) {
...
void ISteamController::StopAnalogActionMomentum(ControllerHandle_t controllerHandle, ControllerAnalogActionHandle_t eAction) { debug("ISteamController::StopAnalogActionMomentum()"); }
void ISteamController::TriggerHapticPulse(ControllerHandle_t controllerHandle, ESteamControllerPad eTargetPad, unsigned short usDurationMicroSec) { debug("ISteamController::TriggerHapticPulse()"); }
void ISteamController::TriggerRepeatedHapticPulse(ControllerHandle_t controllerHandle, ESteamControllerPad eTargetPad, unsigned short usDurationMicroSec, unsigned short usOffMicroSec, unsigned short unRepeat, unsigned int nFlags) { debug("ISteamController::TriggerRepeatedHapticPulse()"); }
void ISteamController::TriggerVibration(ControllerHandle_t controllerHandle, unsigned short usLeftSpeed, unsigned short usRightSpeed) { debug("ISteamController::TriggerVibration()"); }
void ISteamController::SetLEDColor(ControllerHandle_t controllerHandle, uint8 nColorR, uint8 nColorG, uint8 nColorB, unsigned int nFlags) { debug("ISteamController::SetLEDColor()"); }
int  ISteamController::GetGamepadIndexForController(ControllerHandle_t ulControllerHandle) {
...
ControllerMotionData_t ISteamController::GetMotionData(ControllerHandle_t controllerHandle) {
  debug("ISteamController::GetMotionData()");
  return {};
}
bool ISteamController::ShowDigitalActionOrigins(ControllerHandle_t controllerHandle, ControllerDigitalActionHandle_t digitalActionHandle, float flScale, float flXPosition, float flYPosition) {
  debug("ISteamController::ShowDigitalActionOrigins()");
  return true;
}
bool ISteamController::ShowAnalogActionOrigins(ControllerHandle_t controllerHandle, ControllerAnalogActionHandle_t analogActionHandle, float flScale, float flXPosition, float flYPosition) {
  debug("ISteamController::ShowAnalogActionOrigins()");
  return true;
}
const char *ISteamController::GetStringForActionOrigin(EControllerActionOrigin eOrigin) {
  debug("ISteamController::GetStringForActionOrigin()");
  return "";
}
const char *ISteamController::GetGlyphForActionOrigin(EControllerActionOrigin eOrigin) {
  debug("ISteamController::GetGlyphForActionOrigin()");
  return "";
}
ESteamInputType ISteamController::GetInputTypeForHandle(ControllerHandle_t controllerHandle) {
  debug("ISteamController::GetInputTypeForHandle()");
  return {};
}

UGCQueryHandle_t ISteamUGC::CreateQueryUserUGCRequest(AccountID_t unAccountID, EUserUGCList eListType, EUGCMatchingUGCType eMatchingUGCType, EUserUGCListSortOrder eSortOrder, AppId_t nCreatorAppID, AppId_t nConsumerAppID, uint32 unPage) {
  debug("ISteamUGC::CreateQueryUserUGCRequest()");
  return {};
}
UGCQueryHandle_t ISteamUGC::CreateQueryAllUGCRequest(EUGCQuery eQueryType, EUGCMatchingUGCType eMatchingeMatchingUGCTypeFileType, AppId_t nCreatorAppID, AppId_t nConsumerAppID, uint32 unPage) {
  debug("ISteamUGC::CreateQueryAllUGCRequest()");
  return {};
}
UGCQueryHandle_t ISteamUGC::CreateQueryUGCDetailsRequest(PublishedFileId_t *pvecPublishedFileID, uint32 unNumPublishedFileIDs) {
...
bool ISteamUGC::GetQueryUGCResult(UGCQueryHandle_t handle, uint32 index, struct SteamUGCDetails_t *pDetails) {
  debug("ISteamUGC::GetQueryUGCResult()");
  return true;
}
bool ISteamUGC::GetQueryUGCPreviewURL(UGCQueryHandle_t handle, uint32 index, char *pchURL, uint32 cchURLSize) {
  debug("ISteamUGC::GetQueryUGCPreviewURL()");
  return true;
}
bool ISteamUGC::GetQueryUGCMetadata(UGCQueryHandle_t handle, uint32 index, char *pchMetadata, uint32 cchMetadatasize) {
  debug("ISteamUGC::GetQueryUGCMetadata()");
  return true;
}
bool ISteamUGC::GetQueryUGCChildren(UGCQueryHandle_t handle, uint32 index, PublishedFileId_t *pvecPublishedFileID, uint32 cMaxEntries) {
  debug("ISteamUGC::GetQueryUGCChildren()");
  return true;
}
bool ISteamUGC::GetQueryUGCStatistic(UGCQueryHandle_t handle, uint32 index, EItemStatistic eStatType, uint64 *pStatValue) {
  debug("ISteamUGC::GetQueryUGCStatistic()");
  return true;
}
uint32 ISteamUGC::GetQueryUGCNumAdditionalPreviews(UGCQueryHandle_t handle, uint32 index) {
  debug("ISteamUGC::GetQueryUGCNumAdditionalPreviews()");
  return 0;
}
bool ISteamUGC::GetQueryUGCAdditionalPreview(UGCQueryHandle_t handle, uint32 index, uint32 previewIndex, char *pchURLOrVideoID, uint32 cchURLSize, char *pchOriginalFileName, uint32 cchOriginalFileNameSize, EItemPreviewType *pPreviewType) {
  debug("ISteamUGC::GetQueryUGCAdditionalPreview()");
  return true;
}
uint32 ISteamUGC::GetQueryUGCNumKeyValueTags(UGCQueryHandle_t handle, uint32 index) {
  debug("ISteamUGC::GetQueryUGCNumKeyValueTags()");
  return 0;
}
bool ISteamUGC::GetQueryUGCKeyValueTag(UGCQueryHandle_t handle, uint32 index, uint32 keyValueTagIndex, char *pchKey, uint32 cchKeySize, char *pchValue, uint32 cchValueSize) {
...
bool ISteamUGC::SetAllowCachedResponse(UGCQueryHandle_t handle, uint32 unMaxAgeSeconds) {
...
SteamAPICall_t ISteamUGC::RequestUGCDetails(PublishedFileId_t nPublishedFileID, uint32 unMaxAgeSeconds) {
...
bool ISteamUGC::SetItemTags(UGCUpdateHandle_t updateHandle, const struct SteamParamStringArray_t *pTags) {
...
bool ISteamUGC::UpdateItemPreviewFile(UGCUpdateHandle_t handle, uint32 index, const char *pszPreviewFile) {
  debug("ISteamUGC::UpdateItemPreviewFile()");
  return true;
}
bool ISteamUGC::UpdateItemPreviewVideo(UGCUpdateHandle_t handle, uint32 index, const char *pszVideoID) {
...
EItemUpdateStatus ISteamUGC::GetItemUpdateProgress(UGCUpdateHandle_t handle, uint64 *punBytesProcessed, uint64 *punBytesTotal) {
...
uint32 ISteamUGC::GetSubscribedItems(PublishedFileId_t *pvecPublishedFileID, uint32 cMaxEntries) {
...
bool ISteamUGC::GetItemInstallInfo(PublishedFileId_t nPublishedFileID, uint64 *punSizeOnDisk, char *pchFolder, uint32 cchFolderSize, uint32 *punTimeStamp) {
  debug("ISteamUGC::GetItemInstallInfo()");
  return true;
}
bool ISteamUGC::GetItemDownloadInfo(PublishedFileId_t nPublishedFileID, uint64 *punBytesDownloaded, uint64 *punBytesTotal) {
  debug("ISteamUGC::GetItemDownloadInfo()");
  return true;
}
bool ISteamUGC::DownloadItem(PublishedFileId_t nPublishedFileID, bool bHighPriority) {
  debug("ISteamUGC::DownloadItem()");
  return true;
}
bool ISteamUGC::BInitWorkshopForGameServer(DepotId_t unWorkshopDepotID, const char *pszFolder) {
  debug("ISteamUGC::BInitWorkshopForGameServer()");
  return true;
}
void           ISteamUGC::SuspendDownloads(bool bSuspend) { debug("ISteamUGC::SuspendDownloads()"); }
SteamAPICall_t ISteamUGC::StartPlaytimeTracking(PublishedFileId_t *pvecPublishedFileID, uint32 unNumPublishedFileIDs) {
  debug("ISteamUGC::StartPlaytimeTracking()");
  return {};
}
SteamAPICall_t ISteamUGC::StopPlaytimeTracking(PublishedFileId_t *pvecPublishedFileID, uint32 unNumPublishedFileIDs) {
...
SteamAPICall_t ISteamUGC::AddDependency(PublishedFileId_t nParentPublishedFileID, PublishedFileId_t nChildPublishedFileID) {
  debug("ISteamUGC::AddDependency()");
  return {};
}
SteamAPICall_t ISteamUGC::RemoveDependency(PublishedFileId_t nParentPublishedFileID, PublishedFileId_t nChildPublishedFileID) {
  debug("ISteamUGC::RemoveDependency()");
  return {};
}
SteamAPICall_t ISteamUGC::AddAppDependency(PublishedFileId_t nPublishedFileID, AppId_t nAppID) {
  debug("ISteamUGC::AddAppDependency()");
  return {};
}
SteamAPICall_t ISteamUGC::RemoveAppDependency(PublishedFileId_t nPublishedFileID, AppId_t nAppID) {
  debug("ISteamUGC::RemoveAppDependency()");
  return {};
}
SteamAPICall_t ISteamUGC::GetAppDependencies(PublishedFileId_t nPublishedFileID) {
...
int ISteamAppList::GetAppInstallDir(AppId_t nAppID, char *pchDirectory, int cchNameMax) {
...
bool ISteamInventory::GetResultItems(SteamInventoryResult_t resultHandle, struct SteamItemDetails_t *pOutItemsArray, uint32 *punOutItemsArraySize) {
  debug("ISteamInventory::GetResultItems()");
  return true;
}
bool ISteamInventory::GetResultItemProperty(SteamInventoryResult_t resultHandle, uint32 unItemIndex, const char *pchPropertyName, char *pchValueBuffer, uint32 *punValueBufferSizeOut) {
  debug("ISteamInventory::GetResultItemProperty()");
  return true;
}
uint32 ISteamInventory::GetResultTimestamp(SteamInventoryResult_t resultHandle) {
  debug("ISteamInventory::GetResultTimestamp()");
  return 0;
}
bool ISteamInventory::CheckResultSteamID(SteamInventoryResult_t resultHandle, class CSteamID steamIDExpected) {
  debug("ISteamInventory::CheckResultSteamID()");
  return true;
}
void ISteamInventory::DestroyResult(SteamInventoryResult_t resultHandle) { debug("ISteamInventory::DestroyResult()"); }
bool ISteamInventory::GetAllItems(SteamInventoryResult_t *pResultHandle) {
  debug("ISteamInventory::GetAllItems()");
  return true;
}
bool ISteamInventory::GetItemsByID(SteamInventoryResult_t *pResultHandle, const SteamItemInstanceID_t *pInstanceIDs, uint32 unCountInstanceIDs) {
  debug("ISteamInventory::GetItemsByID()");
  return true;
}
bool ISteamInventory::SerializeResult(SteamInventoryResult_t resultHandle, void *pOutBuffer, uint32 *punOutBufferSize) {
  debug("ISteamInventory::SerializeResult()");
  return true;
}
bool ISteamInventory::DeserializeResult(SteamInventoryResult_t *pOutResultHandle, const void *pBuffer, uint32 unBufferSize, bool bRESERVED_MUST_BE_FALSE) {
  debug("ISteamInventory::DeserializeResult()");
  return true;
}
bool ISteamInventory::GenerateItems(SteamInventoryResult_t *pResultHandle, const SteamItemDef_t *pArrayItemDefs, const uint32 *punArrayQuantity, uint32 unArrayLength) {
...
bool ISteamInventory::AddPromoItem(SteamInventoryResult_t *pResultHandle, SteamItemDef_t itemDef) {
  debug("ISteamInventory::AddPromoItem()");
  return true;
}
bool ISteamInventory::AddPromoItems(SteamInventoryResult_t *pResultHandle, const SteamItemDef_t *pArrayItemDefs, uint32 unArrayLength) {
  debug("ISteamInventory::AddPromoItems()");
  return true;
}
bool ISteamInventory::ConsumeItem(SteamInventoryResult_t *pResultHandle, SteamItemInstanceID_t itemConsume, uint32 unQuantity) {
  debug("ISteamInventory::ConsumeItem()");
  return true;
}
bool ISteamInventory::ExchangeItems(SteamInventoryResult_t *pResultHandle, const SteamItemDef_t *pArrayGenerate, const uint32 *punArrayGenerateQuantity, uint32 unArrayGenerateLength, const SteamItemInstanceID_t *pArrayDestroy, const uint32 *punArrayDestroyQuantity, uint32 unArrayDestroyLength) {
  debug("ISteamInventory::ExchangeItems()");
  return true;
}
bool ISteamInventory::TransferItemQuantity(SteamInventoryResult_t *pResultHandle, SteamItemInstanceID_t itemIdSource, uint32 unQuantity, SteamItemInstanceID_t itemIdDest) {
  debug("ISteamInventory::TransferItemQuantity()");
  return true;
}
void ISteamInventory::SendItemDropHeartbeat() { debug("ISteamInventory::SendItemDropHeartbeat()"); }
bool ISteamInventory::TriggerItemDrop(SteamInventoryResult_t *pResultHandle, SteamItemDef_t dropListDefinition) {
  debug("ISteamInventory::TriggerItemDrop()");
  return true;
}
bool ISteamInventory::TradeItems(SteamInventoryResult_t *pResultHandle, class CSteamID steamIDTradePartner, const SteamItemInstanceID_t *pArrayGive, const uint32 *pArrayGiveQuantity, uint32 nArrayGiveLength, const SteamItemInstanceID_t *pArrayGet, const uint32 *pArrayGetQuantity, uint32 nArrayGetLength) {
...
bool ISteamInventory::GetItemDefinitionIDs(SteamItemDef_t *pItemDefIDs, uint32 *punItemDefIDsArraySize) {
  debug("ISteamInventory::GetItemDefinitionIDs()");
  return true;
}
bool ISteamInventory::GetItemDefinitionProperty(SteamItemDef_t iDefinition, const char *pchPropertyName, char *pchValueBuffer, uint32 *punValueBufferSizeOut) {
  debug("ISteamInventory::GetItemDefinitionProperty()");
  return true;
}
SteamAPICall_t ISteamInventory::RequestEligiblePromoItemDefinitionsIDs(class CSteamID steamID) {
  debug("ISteamInventory::RequestEligiblePromoItemDefinitionsIDs()");
  return {};
}
bool ISteamInventory::GetEligiblePromoItemDefinitionIDs(class CSteamID steamID, SteamItemDef_t *pItemDefIDs, uint32 *punItemDefIDsArraySize) {
  debug("ISteamInventory::GetEligiblePromoItemDefinitionIDs()");
  return true;
}
SteamAPICall_t ISteamInventory::StartPurchase(const SteamItemDef_t *pArrayItemDefs, const uint32 *punArrayQuantity, uint32 unArrayLength) {
...
bool ISteamInventory::GetItemsWithPrices(SteamItemDef_t *pArrayItemDefs, uint64 *pPrices, uint32 unArrayLength) {
...
bool ISteamInventory::RemoveProperty(SteamInventoryUpdateHandle_t handle, SteamItemInstanceID_t nItemID, const char *pchPropertyName) {
  debug("ISteamInventory::RemoveProperty()");
  return true;
}
bool ISteamInventory::SetProperty(SteamInventoryUpdateHandle_t handle, SteamItemInstanceID_t nItemID, const char *pchPropertyName, const char *pchPropertyValue) {
  debug("ISteamInventory::SetProperty()");
  return true;
}
bool ISteamInventory::SetProperty(SteamInventoryUpdateHandle_t handle, SteamItemInstanceID_t nItemID, const char *pchPropertyName, bool bValue) {
  debug("ISteamInventory::SetProperty()");
  return true;
}
bool ISteamInventory::SetProperty(SteamInventoryUpdateHandle_t handle, SteamItemInstanceID_t nItemID, const char *pchPropertyName, int64 nValue) {
  debug("ISteamInventory::SetProperty()");
  return true;
}
bool ISteamInventory::SetProperty(SteamInventoryUpdateHandle_t handle, SteamItemInstanceID_t nItemID, const char *pchPropertyName, float flValue) {
  debug("ISteamInventory::SetProperty()");
  return true;
}
bool ISteamInventory::SubmitUpdateProperties(SteamInventoryUpdateHandle_t handle, SteamInventoryResult_t *pResultHandle) {
  debug("ISteamInventory::SubmitUpdateProperties()");
  return true;
}

void ISteamVideo::GetVideoURL(AppId_t unVideoAppID) { debug("ISteamVideo::GetVideoURL()"); }
bool ISteamVideo::IsBroadcasting(int *pnNumViewers) {
  debug("ISteamVideo::IsBroadcasting()");
  return true;
}
void ISteamVideo::GetOPFSettings(AppId_t unVideoAppID) { debug("ISteamVideo::GetOPFSettings()"); }
bool ISteamVideo::GetOPFStringForApp(AppId_t unVideoAppID, char *pchBuffer, int32 *pnBufferSize) {
...
bool ISteamGameServer::InitGameServer(uint32 unIP, uint16 usGamePort, uint16 usQueryPort, uint32 unFlags, AppId_t nGameAppId, const char *pchVersionString) {
  debug("ISteamGameServer::InitGameServer()");
  return true;
}
void ISteamGameServer::SetProduct(const char *pszProduct) { debug("ISteamGameServer::SetProduct()"); }
void ISteamGameServer::SetGameDescription(const char *pszGameDescription) { debug("ISteamGameServer::SetGameDescription()"); }
void ISteamGameServer::SetModDir(const char *pszModDir) { debug("ISteamGameServer::SetModDir()"); }
void ISteamGameServer::SetDedicatedServer(bool bDedicated) { debug("ISteamGameServer::SetDedicatedServer()"); }
void ISteamGameServer::LogOn(const char *pszToken) { debug("ISteamGameServer::LogOn()"); }
void ISteamGameServer::LogOnAnonymous() { debug("ISteamGameServer::LogOnAnonymous()"); }
...
void ISteamGameServer::SetMaxPlayerCount(int cPlayersMax) { debug("ISteamGameServer::SetMaxPlayerCount()"); }
void ISteamGameServer::SetBotPlayerCount(int cBotplayers) { debug("ISteamGameServer::SetBotPlayerCount()"); }
void ISteamGameServer::SetServerName(const char *pszServerName) { debug("ISteamGameServer::SetServerName()"); }
void ISteamGameServer::SetMapName(const char *pszMapName) { debug("ISteamGameServer::SetMapName()"); }
void ISteamGameServer::SetPasswordProtected(bool bPasswordProtected) { debug("ISteamGameServer::SetPasswordProtected()"); }
void ISteamGameServer::SetSpectatorPort(uint16 unSpectatorPort) { debug("ISteamGameServer::SetSpectatorPort()"); }
void ISteamGameServer::SetSpectatorServerName(const char *pszSpectatorServerName) { debug("ISteamGameServer::SetSpectatorServerName()"); }
void ISteamGameServer::ClearAllKeyValues() { debug("ISteamGameServer::ClearAllKeyValues()"); }
void ISteamGameServer::SetKeyValue(const char *pKey, const char *pValue) { debug("ISteamGameServer::SetKeyValue()"); }
void ISteamGameServer::SetGameTags(const char *pchGameTags) { debug("ISteamGameServer::SetGameTags()"); }
void ISteamGameServer::SetGameData(const char *pchGameData) { debug("ISteamGameServer::SetGameData()"); }
void ISteamGameServer::SetRegion(const char *pszRegion) { debug("ISteamGameServer::SetRegion()"); }
bool ISteamGameServer::SendUserConnectAndAuthenticate(uint32 unIPClient, const void *pvAuthBlob, uint32 cubAuthBlobSize, class CSteamID *pSteamIDUser) {
...
void ISteamGameServer::SendUserDisconnect(class CSteamID steamIDUser) { debug("ISteamGameServer::SendUserDisconnect()"); }
bool ISteamGameServer::BUpdateUserData(class CSteamID steamIDUser, const char *pchPlayerName, uint32 uScore) {
  debug("ISteamGameServer::BUpdateUserData()");
  return true;
}
HAuthTicket ISteamGameServer::GetAuthSessionTicket(void *pTicket, int cbMaxTicket, uint32 *pcbTicket) {
  debug("ISteamGameServer::GetAuthSessionTicket()");
  return {};
}
EBeginAuthSessionResult ISteamGameServer::BeginAuthSession(const void *pAuthTicket, int cbAuthTicket, class CSteamID steamID) {
  debug("ISteamGameServer::BeginAuthSession()");
  return {};
}
void                        ISteamGameServer::EndAuthSession(class CSteamID steamID) { debug("ISteamGameServer::EndAuthSession()"); }
void                        ISteamGameServer::CancelAuthTicket(HAuthTicket hAuthTicket) { debug("ISteamGameServer::CancelAuthTicket()"); }
EUserHasLicenseForAppResult ISteamGameServer::UserHasLicenseForApp(class CSteamID steamID, AppId_t appID) {
  debug("ISteamGameServer::UserHasLicenseForApp()");
  return {};
}
bool ISteamGameServer::RequestUserGroupStatus(class CSteamID steamIDUser, class CSteamID steamIDGroup) {
  debug("ISteamGameServer::RequestUserGroupStatus()");
  return true;
}
void           ISteamGameServer::GetGameplayStats() { debug("ISteamGameServer::GetGameplayStats()"); }
...
bool ISteamGameServer::HandleIncomingPacket(const void *pData, int cbData, uint32 srcIP, uint16 srcPort) {
  debug("ISteamGameServer::HandleIncomingPacket()");
  return true;
}
int ISteamGameServer::GetNextOutgoingPacket(void *pOut, int cbMaxOut, uint32 *pNetAdr, uint16 *pPort) {
  debug("ISteamGameServer::GetNextOutgoingPacket()");
  return 0;
}
void           ISteamGameServer::EnableHeartbeats(bool bActive) { debug("ISteamGameServer::EnableHeartbeats()"); }
void           ISteamGameServer::SetHeartbeatInterval(int iHeartbeatInterval) { debug("ISteamGameServer::SetHeartbeatInterval()"); }
void           ISteamGameServer::ForceHeartbeat() { debug("ISteamGameServer::ForceHeartbeat()"); }
SteamAPICall_t ISteamGameServer::AssociateWithClan(class CSteamID steamIDClan) {
  debug("ISteamGameServer::AssociateWithClan()");
  return {};
}
SteamAPICall_t ISteamGameServer::ComputeNewPlayerCompatibility(class CSteamID steamIDNewPlayer) {
  debug("ISteamGameServer::ComputeNewPlayerCompatibility()");
  return {};
}

SteamAPICall_t ISteamGameServerStats::RequestUserStats(class CSteamID steamIDUser) {
  debug("ISteamGameServerStats::RequestUserStats()");
  return {};
}
bool ISteamGameServerStats::GetUserStat(class CSteamID steamIDUser, const char *pchName, int32 *pData) {
  debug("ISteamGameServerStats::GetUserStat()");
  return true;
}
bool ISteamGameServerStats::GetUserStat(class CSteamID steamIDUser, const char *pchName, float *pData) {
  debug("ISteamGameServerStats::GetUserStat()");
  return true;
}
bool ISteamGameServerStats::GetUserAchievement(class CSteamID steamIDUser, const char *pchName, bool *pbAchieved) {
  debug("ISteamGameServerStats::GetUserAchievement()");
  return true;
}
bool ISteamGameServerStats::SetUserStat(class CSteamID steamIDUser, const char *pchName, int32 nData) {
  debug("ISteamGameServerStats::SetUserStat()");
  return true;
}
bool ISteamGameServerStats::SetUserStat(class CSteamID steamIDUser, const char *pchName, float fData) {
  debug("ISteamGameServerStats::SetUserStat()");
  return true;
}
bool ISteamGameServerStats::UpdateUserAvgRateStat(class CSteamID steamIDUser, const char *pchName, float flCountThisSession, double dSessionLength) {
  debug("ISteamGameServerStats::UpdateUserAvgRateStat()");
  return true;
}
bool ISteamGameServerStats::SetUserAchievement(class CSteamID steamIDUser, const char *pchName) {
  debug("ISteamGameServerStats::SetUserAchievement()");
  return true;
}
bool ISteamGameServerStats::ClearUserAchievement(class CSteamID steamIDUser, const char *pchName) {
  debug("ISteamGameServerStats::ClearUserAchievement()");
  return true;
}
SteamAPICall_t ISteamGameServerStats::StoreUserStats(class CSteamID steamIDUser) {
